...
export const GraphicPage = () => {
    ...
    const items:{url:string, alt:string, header:string, bgpos?:string, bottom?:string,}[] = [
        ...
        {url:"https://i.imgur.com/TGTAiD4.png", alt:"I try to put the time and effort to create regularly, whether it's through daily sketching, creating models or painting. Practice is important to hone skills and step forward. I often study the work of other artists, who I like, both past and present, to provide valuable insights and inspiration for myself. When I'm looking at others art I try to name things that impress me mostly, it can be colors, brush strokes or atmosphere for example. After analyzing, I try to recreate or implement these elements into my work to achieve a mix that I will call my personal style. I think repeatability is something I lack the most at the moment. Learning it would help me realize projects like comics or animations, because they need to keep the same style for the time when we work on it.", header:"Process of learning.", bgpos:"top", bottom:"50px"},
        {url:"https://i.imgur.com/Zj3x92X.png", alt:"Mastering art takes time and patience, so sometimes it is hard to manage for me. There are times when I make short breaks from it to regain determination and will to create. However, I set my goals and I know that I have to keep going for the sake of achieving them. I often ask for opinions to improve my works and learn for the future projects. I try to work with different mediums, or challenge yourself to create in a new style. Stepping outside from my comfort zone helps me discover new techniques and tools. Finally, I think that developing and enjoying art is essential to mastering it.", header:"Constant progress.", bgpos:"center", bottom:"100px"},
     ];
