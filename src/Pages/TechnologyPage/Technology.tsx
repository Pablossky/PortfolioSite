...
export const TechnologyPage = () => {
    ...
    const items:{url:string, alt:string, header:string, bgpos?:string, bottom?:string,}[] = [
        ...
        {url:"https://i.imgur.com/FilM8u7.png", alt:"There's plenty of branches of IT that are interesting me, so I hope I'll have enough determination to learn about all of them in the future. Some of them probably will be a tough nut to crack, but I hope I'll manage somehow learning them.", header:"Constant progress.", bgpos:"center", bottom:"100px"},
     ];
