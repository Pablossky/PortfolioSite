...
export const MusicProductionPage = () => {
    ...
    const items:{url:string, alt:string, header:string, bgpos?:string, bottom?:string,}[] = [
        ...
        {url:"https://i.imgur.com/OFzxNUb.png", alt:"Collaborating with others can also bring fresh perspectives and ideas. Playing music together with friends makes us having even more fun. Shared experience can deepen bond between people. Even small talks about musical stuff are great way to express your creativy. I enjoy discussing about favourite musician's pieces, genres or even about music theory. Together with two of my childhood friends we practice and play as a garage band. I wish I had more time to practice together, but even I have breaks from it and forget some tracks we have a lot of fun learning to play them together again. Maybe if we stick to training regurarly, we'll start to release our own songs.", header:"Playing together.", bgpos:"center", bottom:"200px"},
     ];
